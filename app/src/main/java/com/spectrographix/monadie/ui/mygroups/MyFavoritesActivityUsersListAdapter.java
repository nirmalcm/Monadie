...
public class MyFavoritesActivityUsersListAdapter extends RecyclerView.Adapter
{
    private List<User> groupMembers;
    private Context context;

    public MyFavoritesActivityUsersListAdapter(Context context, List<User> groupMembers)
    {
    ...
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.myfavorites_activity_my_favorites_adapter_users_list, parent, false);
